...
router.get('/education', function (req, res) {
  ...
  res.render('education', {
    ...
    main: {
      educations: [
        {
          name: 'Навчально-виховний комплекс №37',
          isEnd: true,
        },
        {
          name: 'ДНУ Олеся Гончара',
          isEnd: true,
        },
        {
      ...
      certificates: [
        {
          name: 'Международный школьный сертификат',
          id: 1001,
        },
        {
          name: 'Сертификат об онлайн-обучении',
          id: 222,
        },
        {
          name: 'Cертификат о прохождении курса',
          id: 17,
        },
      ],
    },
          ...
          projects: [
            {
              ...
              about:
                'Создание тематической страницы на базе научно-образовательного портала IQ HSE',
              stacks: [
                {
                  name: 'React.js',
                },
              ...
              awards: [
                {
                  name: 'Любая культурная инициатива начинается с проекта',
                },
                {
                  name: 'На странице Информация о проекте вы можете просмотреть важную информацию',
                },
              ],
              stackAmount: 7,
              awardAmount: 3,
